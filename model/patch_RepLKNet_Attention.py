...
class PatchRepLKNetAttention(nn.Module):
    def __init__(self, dim = 768, depth = 3, kernel_size = 7, patch_size = 16, n_classes = 2):
        super(PatchRepLKNetAttention, self).__init__()
        self.dim = dim
        self.depth = depth
        ...
        self.RepLKNet = RepLKNet(dim, depth, kernel_size)
...
if __name__ == '__main__':
    ...
    model = PatchRepLKNetAttention(dim = 768, depth = 4, kernel_size = 7, patch_size = 16, n_classes = 2)
    # print(model)
